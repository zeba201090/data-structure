...
//        for(i=0; i < n; i++)
        {
            if(items[i].w <= W)
            {
                ...
                cout << "item value: " <<items[i].v << endl;
                //this flag is to identify the taken items by chor 1
                flag++;
            ...
            else
            {
                ...
                cout <<"item value:" <<items[i].v * ((double)W / (double)items[i].w) <<endl;
                //updating the fractional weight
